    ...
    <div className="amz-container py-6">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[#d5d9d9] rounded-lg p-8 text-center shadow-sm">
          ...
          <p className="text-lg text-[#0f1111] font-medium">Please sign in to view your orders</p>
        ...
        <div className="bg-white border border-[#d5d9d9] rounded-lg p-8 text-center shadow-sm">
          ...
          <p className="text-sm text-[#565959] mt-1">Looks like you haven&apos;t placed any orders</p>
            ...
            >
              ...
              <div className="bg-[#f0f2f2] px-4 py-3 flex flex-wrap gap-4 text-sm border-b border-[#d5d9d9]">
                ...
                <div>
                  ...
                  <p className="text-[#0f1111] font-bold">₹{Number(order.total).toLocaleString()}</p>
                </div>
                <div className="ml-auto text-right">
                  <p className="text-xs text-[#565959] uppercase tracking-wide">Order #</p>
              ...
              <div className="px-4 py-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-[#007600]">Delivered</span>
                </div>
