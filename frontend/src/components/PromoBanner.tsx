...
export function PromoBanner() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {/* Today's Deals */}
      <div className="promo-card" style={{ background: "linear-gradient(135deg, #cc0c39 0%, #8b0000 100%)" }}>
      ...
      {/* Prime Exclusive */}
      <div className="promo-card" style={{ background: "linear-gradient(135deg, #232f3e 0%, #1a3a5c 100%)" }}>
        <div className="relative z-10 text-white">
