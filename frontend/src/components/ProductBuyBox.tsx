  ...
  return (
    <div className="rounded-lg border border-[#d5d9d9] bg-white p-4 shadow-sm sm:p-5">
      ...
      <p className="text-xs text-[#565959] mt-0.5">
        Order within <span className="font-bold text-[#007600]">12 hrs 30 mins</span>
      </p>
      ...
      <div className="mt-4 border-t border-[#e7e7e7] pt-4 text-xs text-[#565959] space-y-1">
        <p className="flex justify-between"><span>Ships from</span><span className="text-[#0f1111]">Amazon Clone</span></p>
        <p className="flex justify-between"><span>Sold by</span><span className="text-[#007185]">Amazon Clone Store</span></p>
      </div>
    </div>
  );
}
